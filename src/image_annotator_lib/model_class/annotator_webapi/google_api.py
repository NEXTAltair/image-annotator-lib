"""Google Gemini API Annotator (PydanticAI-based)."""
...
class GoogleApiAnnotator(WebApiBaseAnnotator):
    """Google Gemini API を使用するアノテーター (Plan 1 統一実装)."""
    ...
    def __enter__(self):
        ...
        logger.debug(f"Entering context for Google annotator: {self.model_name}")
        return self
