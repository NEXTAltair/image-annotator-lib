...
graph TD
    ...
    D1 --> D1d(core)
        ...
        D1d --> D1d2(config.py)
        D1d --> D1d3(constants.py)
        D1d --> D1d4(model_factory.py)
        D1d --> D1d5(registry.py)
        D1d --> D1d6(utils.py)
        D1d --> D1d7(types.py)
        D1d --> D1d8(base)
            D1d8 --> D1d8a(__init__.py)
            D1d8 --> D1d8b(annotator.py)
            D1d8 --> D1d8c(clip.py)
            D1d8 --> D1d8d(onnx.py)
            D1d8 --> D1d8e(pipeline.py)
            D1d8 --> D1d8f(tensorflow.py)
            D1d8 --> D1d8g(transformers.py)
            D1d8 --> D1d8h(webapi.py)
    D1 --> D1e(exceptions)
        D1e --> D1e1(__init__.py)
        D1e --> D1e2(errors.py)
    D1 --> D1f(model_class)
        D1f --> D1f1(annotator_webapi)
            D1f1 --> D1f1a(anthropic_api.py)
            D1f1 --> D1f1b(google_api.py)
            D1f1 --> D1f1c(openai_api_chat.py)
            D1f1 --> D1f1d(openai_api_response.py)
            D1f1 --> D1f1e(webapi_shared.py)
