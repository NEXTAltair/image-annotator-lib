"""
BaseAnnotator - Reference implementation for prototype development

This is a copy of the stable BaseAnnotator class for reference during
PydanticAI integration development. The actual BaseAnnotator will remain
unchanged during the WebApiBaseAnnotator replacement.

Original: src/image_annotator_lib/core/base/annotator.py
"""
...
from image_annotator_lib.core.types import AnnotationResult, LoaderComponents
from image_annotator_lib.core.utils import logger

# --- Local imports (adjusted for prototype context) ---
# Note: In prototype, we import from main package
...
class BaseAnnotator(ABC):
    ...
    NOTE: This is a reference copy for prototype development.
    The actual implementation should remain unchanged.
    """
